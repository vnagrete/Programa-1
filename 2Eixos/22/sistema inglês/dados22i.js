...
var Eixos = []
var EixosI = [] // Desenho no sistema inglês
var c = 1
var eixo = {
    comprimento : comprimento,
    inclinação : inclinação
}
var eixoI ={ // Desenho no sistema inglês
    comprimento : comprimento
}
var Motor = []
var motor = {
...
function entt()
{
    ...
    document.getElementById('tdeterminado').innerHTML = "O torque de entrada no eixo 1 é: " + t + " lbf.in"
    motor = {
        t : Number(t),
...
{ 
    ...
    if (document.getElementById('comprimento').value < 4)
    {
        alert("O comprimento do eixo deve ser de no mínimo 4 in!")
    }
    ...
    else
    {
        ...
        eixoI = { // Usado para desenho com sistema inglês 
            comprimento : Number(comprimento*25.4)
        }
        Eixos.push(eixo)
        EixosI.push(eixoI) // Usado para desenho com sistema inglês
...
function dadosdoeixo()
{
    ...
    if (c == 2)
    {
        ...
        ctx3.fillText("Comprimento: " + Eixos[0].comprimento + " in",20,100)
        ctx3.fillText("Inclinação: " + Eixos[0].inclinação + "°",20,130)
    }
    if (c == 3 )
    {
        ctx3.fillText("Eixo \'b\' :",200,70)
        ctx3.fillText("Comprimento: " + Eixos[1].comprimento + " in",200,100)
...
var engrenagemI = //Desenhos no sistema inglês
{
    diametro : diametro
}
var distancias = {
...
var distanciasI = //Desenhos no sistema inglês 
{
    d1 : d1,
    d2 : d2,
    d3 : d3,
...
function detdiametro() //Atualiza o diâmetro ao editar os valores de z e m
{
    ...
    if (CT == 0)
    {
        var pdndiametro = Math.abs(document.getElementById('pdn').value) 
    }
    else if (CT == 1)
    {
        var pdndiametro = Engrenagens[0].pdn
    }
    ...
    else
    {
        if (CT == 0)
        {
            var psidiametro = Math.abs(document.getElementById('psi').value) 
        }
        else if (CT == 1)
        {
            var psidiametro = Engrenagens[0].psi
        }
    }
    
    let diametro = z/(pdndiametro * Math.cos((psidiametro*(Math.PI/180)))) //(diametro)

    if (diametro == 0 || diametro == Infinity)
    {
        document.getElementById('diametro').innerHTML = "Diâmetro: "
    }
    else
    {
        document.getElementById('diametro').innerHTML = "Diâmetro: " + diametro.toFixed(2) + " in"
    }
}
...
function enviardados2 ()
{
    ...
    else
    {
        ...
        {
            var pdn = Math.abs(document.getElementById('pdn').value) //PDN
            document.getElementById('pdn').setAttribute('disabled','true')
        }
        else 
        {
            var pdn = Engrenagens[0].pdn
        }
        ...
        //DIAMETRO
        let diametro = z/(pdn * Math.cos((psi*(Math.PI/180)))) //(diametro)
        ...
        var engrenagemI = { // Usado para fazer os desenhos no sistema inglês

            diametro :Number(diametro*25.4)
        }
        var distancias = {
            d1 : Number(d1),
            d2 : Number(d2),
        ...
        var distanciasI = { // Usado para fazer os desenhos no sistema inglês
            d1 : Number(d1*25.4),
            d2 : Number(d2*25.4),
            d3 : Number(d3*25.4),  
        }
        ...
        EngrenagensI.push(engrenagemI) // Usado para fazer os desenhos no sistema inglês
        DistanciasI.push(distanciasI) // Usado para fazer os desenhos no sistema inglês
...
function desenharsistema ()
{
    ...
    if (EngrenagensI[CE].diametro > 300)
    {
        let scaley = 300/EngrenagensI[CE].diametro
        recty = recty/scaley
        ctx2.scale(scalex,scaley)
    }
    ...
    if (c < 3)
    {
        ctx2.beginPath() // Eixo
        ctx2.fillStyle = "black"
        ctx2.fillRect(rectx,recty,EixosI[(contadoreixos - 1)].comprimento,20)
        ctx2.fill()
        ctx2.closePath()
        ...
        ctx2.strokeStyle = "red"
        ctx2.lineWidth = 2
        ctx2.fillRect(rectx+DistanciasI[CT].d1 - 10,recty,20,20) //Mancal 1
        ctx2.clearRect(rectx+DistanciasI[CT].d1+2 - 10,recty+2,16,16)
        ctx2.moveTo(rectx+DistanciasI[CT].d1+1 - 10,recty+1)
        ctx2.lineTo(rectx+DistanciasI[CT].d1+19 - 10,recty+19)
        ctx2.moveTo(rectx+DistanciasI[CT].d1+1 - 10,recty+19)
        ctx2.lineTo(rectx+DistanciasI[CT].d1+19 - 10,recty+1)

        ctx2.fillRect(rectx+DistanciasI[CT].d2 - 10,recty,20,20) // Mancal 2
        ctx2.clearRect(rectx+DistanciasI[CT].d2+2 - 10,recty+2,16,16)
        ctx2.moveTo(rectx+DistanciasI[CT].d2+1 - 10,recty+1)
        ctx2.lineTo(rectx+DistanciasI[CT].d2+19 - 10,recty+19)
        ctx2.moveTo(rectx+DistanciasI[CT].d2+1 - 10,recty+19)
        ctx2.lineTo(rectx+DistanciasI[CT].d2+19 - 10,recty+1)
        ...
        ctx2.lineWidth = 2
        ctx2.strokeStyle = "black"
        engrenagens(rectx,recty,DistanciasI[CE].d3,EngrenagensI[CE].diametro,CE); //SI
        ctx2.fill()
        ctx2.stroke()
        ctx2.closePath()  
    }
    ...
    if (c == 3)
    {
        if (DistanciasI[CE].d4 == 0 || DistanciasI[CE].d4 == EixosI[(contadoreixos - 1)].comprimento) //Correção na barra da cota
        {
            ctx2.beginPath()
            ctx2.fillStyle = "black"
            ctx2.lineWidth = 2
            ctx2.strokeStyle = "black"
            engrenagens(rectx,recty,DistanciasI[CE].d4,EngrenagensI[CE].diametro,CE); //SI
            ctx2.clearRect(rectx+DistanciasI[CE].d4 - 10, recty+(EngrenagensI[CE].diametro/2)+20,20,5)
            ctx2.clearRect(rectx+DistanciasI[CE].d4 - 10, recty-(EngrenagensI[CE].diametro/2),20,-5)
            ctx2.fill()
            ctx2.stroke()
            ctx2.closePath()
        }
...
function cotas (rectx,recty,CE,CT)
{
    ...
    if(contadoreixos == 1)
    {
        if (DistanciasI[CE].d1 == 0)
        {
            ctx2.fillText( 'A',rectx - 25,recty + 15)
        }
        else
        {
            ctx2.fillText( 'A',rectx + DistanciasI[CE].d1 - 5,recty - 5)
        }
        if (DistanciasI[CE].d2 == EixosI[(contadoreixos - 1)].comprimento)
        {
            ctx2.fillText( 'B',rectx + EixosI[(contadoreixos - 1)].comprimento + 15,recty + 15)
        }
        else
        {
            ctx2.fillText( 'B',rectx + DistanciasI[CE].d2 - 5,recty - 5)
        } 
    } 
    if(contadoreixos == 2 && CE == 1)
    {
        ...
        {
            ctx2.fillText( 'C',rectx + DistanciasI[CE].d1 - 5,recty - 5)
        }
        if (DistanciasI[CE].d2 == EixosI[(contadoreixos - 1)].comprimento)
        {
            ctx2.fillText( 'D',rectx + EixosI[(contadoreixos - 1)].comprimento + 15,recty + 15)
        }
        else
        {
            ctx2.fillText( 'D',rectx + DistanciasI[CE].d2 - 5,recty - 5)
        }   
    }  
    ctx2.font = "14px arial"   
    ...
    if(c < 3)
    {
        ...
        ctx2.lineTo(rectx,recty - (EngrenagensI[CE].diametro/2) - 25)
    
        ctx2.moveTo(rectx + DistanciasI[CE].d3,recty - (EngrenagensI[CE].diametro/2) - 5)//Barra direita da cota da engrenagem 1
        ctx2.lineTo(rectx + DistanciasI[CE].d3,recty - (EngrenagensI[CE].diametro/2) - 25)
    
        ctx2.moveTo(rectx,recty - (EngrenagensI[CE].diametro/2) - 15)//Barra transversal da cota da engrenagem 1
        ctx2.lineTo(rectx + DistanciasI[CE].d3,recty -(EngrenagensI[CE].diametro/2) - 15)
    
        if (DistanciasI[CE].d3 == 0)
        {
            ctx2.fillText( Distancias[CE].d3,rectx + DistanciasI[CE].d3/2 + 5,recty - (EngrenagensI[CE].diametro/2) - 20)
        }
        else
        {
            ctx2.fillText( Distancias[CE].d3,rectx + DistanciasI[CE].d3/2 - 5,recty - (EngrenagensI[CE].diametro/2) - 20)
        ...
        if (DistanciasI[CE].d3 == 0)
        {
            ctx2.moveTo(rectx,recty + (EngrenagensI[CE].diametro/2) + 25)//Barra esquerda da cota geral
            ctx2.lineTo(rectx,recty + 115 + (EngrenagensI[CE].diametro/2))  
        }
        else
        {
            ctx2.moveTo(rectx,recty + 25)//Barra esquerda da cota geral
        ...
        if (DistanciasI[CE].d3 == EixosI[(contadoreixos - 1)].comprimento)
        {
            ctx2.moveTo(rectx + EixosI[(contadoreixos - 1)].comprimento,recty + (EngrenagensI[CE].diametro/2) + 25)//Barra direita da cota do eixo
            ctx2.lineTo(rectx + EixosI[(contadoreixos - 1)].comprimento,recty + 115 + (EngrenagensI[CE].diametro/2))
        }
        else
        {
            ctx2.moveTo(rectx + EixosI[(contadoreixos - 1)].comprimento,recty + 25)//Barra direita da cota do eixo
            ctx2.lineTo(rectx + EixosI[(contadoreixos - 1)].comprimento,recty + 115 + (EngrenagensI[CE].diametro/2)) 
        }
    
        ctx2.moveTo(rectx,recty + 105 + (EngrenagensI[CE].diametro/2))//Barra transversal da cota do eixo
        ctx2.lineTo(rectx + EixosI[(contadoreixos - 1)].comprimento,recty + 105 + (EngrenagensI[CE].diametro/2))
        ctx2.fillText(Eixos[(contadoreixos - 1)].comprimento,rectx + (EixosI[(contadoreixos - 1)].comprimento)/2 - 5,recty + 100 + (EngrenagensI[CE].diametro/2))
    
    
        ctx2.moveTo(rectx + DistanciasI[CT].d1,recty + 25)//Barra direita da cota do mancal 1
        ctx2.lineTo(rectx + DistanciasI[CT].d1,recty + 50 + (EngrenagensI[CE].diametro/2)) 
        
        ctx2.moveTo(rectx ,recty + 40 + (EngrenagensI[CE].diametro/2))//Barra transversal da cota do mancal 1
        ctx2.lineTo(rectx + DistanciasI[CT].d1,recty + 40 + (EngrenagensI[CE].diametro/2)) 
        if (DistanciasI[CT].d1 == 0)
        {
            ctx2.fillText(Distancias[CT].d1, rectx + DistanciasI[CT].d1/2 + 5,recty + 35 + (EngrenagensI[CE].diametro/2))
        }
        else
        {
            ctx2.fillText(Distancias[CT].d1, rectx + DistanciasI[CT].d1/2 ,recty + 35 + (EngrenagensI[CE].diametro/2))
        }
    
        ctx2.moveTo(rectx + DistanciasI[CT].d2,recty + 25)//Barra direita da cota do mancal 2
        ctx2.lineTo(rectx + DistanciasI[CT].d2,recty + 80 + (EngrenagensI[CE].diametro/2))
        
        ctx2.moveTo(rectx,recty + 70 + (EngrenagensI[CE].diametro/2))//Barra transversal da cota do mancal 2
        ctx2.lineTo(rectx + DistanciasI[CT].d2,recty + 70 + (EngrenagensI[CE].diametro/2))
        ctx2.fillText(Distancias[CT].d2,rectx + DistanciasI[CT].d2/2 - 5,recty + 65 + (EngrenagensI[CE].diametro/2))
    } 


    //Engrenagem 2

    if(c == 3 && EngrenagensI[CE].diametro > EngrenagensI[CE-1].diametro)
    {
    
        ctx2.clearRect(rectx-1,recty + 24 + (EngrenagensI[CE-1].diametro/2),desenhoengrenagens.width,desenhoengrenagens.height) //apagar até final do canvas
        
        if (DistanciasI[CE-1].d3 > DistanciasI[CE].d4)
        {
            ctx2.clearRect(rectx-1, 0,desenhoengrenagens.width, recty - (EngrenagensI[CE-1].diametro/2) - 12)//apagar até final do canvas
    
            ctx2.moveTo(rectx,recty - 5)//Barra esquerda da cota da engrenagem 2
            ctx2.lineTo(rectx,recty - (EngrenagensI[CE].diametro/2) - 25)
    
            ctx2.moveTo(rectx + DistanciasI[CE].d4,recty - (EngrenagensI[CE].diametro/2) - 5)//Barra direita da cota da engrenagem 2
            ctx2.lineTo(rectx + DistanciasI[CE].d4,recty - (EngrenagensI[CE].diametro/2) - 25)
    
            ctx2.moveTo(rectx,recty - (EngrenagensI[CE].diametro/2) - 15)//Barra transversal da cota da engrenagem 2
            ctx2.lineTo(rectx + DistanciasI[CE].d4,recty -(EngrenagensI[CE].diametro/2) - 15)
    
            ctx2.fillText( Distancias[CE].d4,rectx + DistanciasI[CE].d4/2 - 5,recty - (EngrenagensI[CE].diametro/2) - 20) //Cota da engrenagem 2
    
    
            ctx2.moveTo(rectx,recty - 5)//Barra esquerda da cota da engrenagem 1
            ctx2.lineTo(rectx,recty - (EngrenagensI[CE].diametro/2) - 55)
    
            ctx2.moveTo(rectx + DistanciasI[CE-1].d3,recty - (EngrenagensI[CE-1].diametro/2) - 5)//Barra direita da cota da engrenagem 1
            ctx2.lineTo(rectx + DistanciasI[CE-1].d3,recty - (EngrenagensI[CE].diametro/2) - 55)
    
            ctx2.moveTo(rectx,recty - (EngrenagensI[CE].diametro/2) - 45)//Barra transversal da cota da engrenagem 1
            ctx2.lineTo(rectx + DistanciasI[CE-1].d3,recty -(EngrenagensI[CE].diametro/2) - 45)
            if (DistanciasI[CE-1].d3 == 0)
            {
                ctx2.fillText( Distancias[CE-1].d3,rectx + DistanciasI[CE-1].d3/2 + 5,recty - (EngrenagensI[CE].diametro/2) - 50) //Cota da engrenagem 1
            }
            else
            {
                ctx2.fillText( Distancias[CE-1].d3,rectx + DistanciasI[CE-1].d3/2 - 5,recty - (EngrenagensI[CE].diametro/2) - 50) //Cota da engrenagem 1
        ...
        else if ((EngrenagensI[CE].diametro/2) - (EngrenagensI[CE-1].diametro/2) < 30) //Nesse caso deve-se ter um espaçamento mínimo entre as cotas
        {
            ctx2.moveTo(rectx,recty - 5)//Barra esquerda da cota da engrenagem 2
            ctx2.lineTo(rectx,recty - (EngrenagensI[CE-1].diametro/2) - 55)
    
            ctx2.moveTo(rectx + DistanciasI[CE].d4,recty - (EngrenagensI[CE].diametro/2) - 5)//Barra direita da cota da engrenagem 2
            ctx2.lineTo(rectx + DistanciasI[CE].d4,recty - (EngrenagensI[CE-1].diametro/2) - 55)
    
            ctx2.moveTo(rectx,recty - (EngrenagensI[CE-1].diametro/2) - 45)//Barra transversal da cota da engrenagem 2
            ctx2.lineTo(rectx + DistanciasI[CE].d4,recty - (EngrenagensI[CE-1].diametro/2) - 45)
    
            ctx2.fillText( Distancias[CE].d4,rectx + DistanciasI[CE].d4/2 - 5,recty - (EngrenagensI[CE-1].diametro/2) - 50)
        }
        else if (DistanciasI[CE-1].d3 < DistanciasI[CE].d4 && DistanciasI[CE].d4 !== 0)
        {
            ctx2.moveTo(rectx,recty - 5)//Barra esquerda da cota da engrenagem 2
            ctx2.lineTo(rectx,recty - (EngrenagensI[CE].diametro/2) - 25)
        ...
        if (DistanciasI[CE-1].d3 == 0) //Engrenagem 1 na ponta inicial do eixo
        {
            ctx2.moveTo(rectx,recty + (EngrenagensI[CE-1].diametro/2) + 25)//Barra esquerda da cota geral
            ctx2.lineTo(rectx,recty + 115 + (EngrenagensI[CE].diametro/2))
        }
        else if (DistanciasI[CE].d4 == 0) //Engrenagem 2 na ponta inicial do eixo
        {
            ctx2.moveTo(rectx,recty + (EngrenagensI[CE].diametro/2) + 25)//Barra esquerda da cota geral
            ctx2.lineTo(rectx,recty + 115 + (EngrenagensI[CE].diametro/2))  
        }
        ...
        if (DistanciasI[CE-1].d3 == EixosI[(contadoreixos - 1)].comprimento) //Engrenagem 1 na ponta final do eixo
        {
            ctx2.moveTo(rectx + EixosI[(contadoreixos - 1)].comprimento,recty + (EngrenagensI[CE-1].diametro/2) + 25)//Barra direita da cota do eixo
            ctx2.lineTo(rectx + EixosI[(contadoreixos - 1)].comprimento,recty + 115 + (EngrenagensI[CE].diametro/2))
        }
        else if (DistanciasI[CE].d4 == EixosI[(contadoreixos - 1)].comprimento) // Engrenagem 2 na ponta final do eixo
        {
            ctx2.moveTo(rectx + EixosI[(contadoreixos - 1)].comprimento,recty + (EngrenagensI[CE].diametro/2) + 25)//Barra direita da cota do eixo
            ctx2.lineTo(rectx + EixosI[(contadoreixos - 1)].comprimento,recty + 115 + (EngrenagensI[CE].diametro/2))
        }
    ...
    if (c == 3 && EngrenagensI[CE].diametro < EngrenagensI[CE-1].diametro)
    {
        if (DistanciasI[CE].d4 < DistanciasI[CE-1].d3)
        {
            if ((EngrenagensI[CE-1].diametro/2) - (EngrenagensI[CE].diametro/2) < 30)
            {
                ctx2.clearRect(rectx-1, 0,desenhoengrenagens.width, recty - (EngrenagensI[CE-1].diametro/2) - 3)//apagar cota da engrenagem 1

                ctx2.moveTo(rectx,recty - 5)//Barra esquerda da cota da engrenagem 1
                ctx2.lineTo(rectx,recty - (EngrenagensI[CE-1].diametro/2) - 55)
        
                ctx2.moveTo(rectx + DistanciasI[CE-1].d3,recty - (EngrenagensI[CE-1].diametro/2) - 5)//Barra direita da cota da engrenagem 1
                ctx2.lineTo(rectx + DistanciasI[CE-1].d3,recty - (EngrenagensI[CE-1].diametro/2) - 55)
        
                ctx2.moveTo(rectx,recty - (EngrenagensI[CE-1].diametro/2) - 45)//Barra transversal da cota da engrenagem 1
                ctx2.lineTo(rectx + DistanciasI[CE-1].d3,recty - (EngrenagensI[CE-1].diametro/2) - 45)
        
                ctx2.fillText( Distancias[CE-1].d3,rectx + DistanciasI[CE-1].d3/2 - 10,recty - (EngrenagensI[CE-1].diametro/2) - 50)
            }
        ...
        else
        {
            ...
            ctx2.fillText( Distancias[CE].d4,rectx + DistanciasI[CE].d4/2 - 5,recty - (EngrenagensI[CE-1].diametro/2) - 50) //Cota da engrenagem 2
        }
    }
    ...
    if (c == 3 && EngrenagensI[CE].diametro == EngrenagensI[CE-1].diametro)
    {
        if (DistanciasI[CE].d4 < DistanciasI[CE-1].d3)
        {
            ctx2.clearRect(rectx-1, 0,desenhoengrenagens.width, recty - (EngrenagensI[CE-1].diametro/2) - 3)
            ...
            ctx2.fillText( Distancias[CE].d4,rectx + DistanciasI[CE].d4/2 - 10,recty - (EngrenagensI[CE-1].diametro/2) - 50) //Cota da engrenagem 2
    
    
            ctx2.moveTo(rectx + DistanciasI[CE-1].d3,recty - (EngrenagensI[CE-1].diametro/2) - 5)//Barra direita da cota da engrenagem 1
            ctx2.lineTo(rectx + DistanciasI[CE-1].d3,recty - (EngrenagensI[CE-1].diametro/2) - 25)
    
            ctx2.moveTo(rectx,recty - (EngrenagensI[CE-1].diametro/2) - 15)//Barra transversal da cota da engrenagem 1
            ctx2.lineTo(rectx + DistanciasI[CE-1].d3,recty -(EngrenagensI[CE-1].diametro/2) - 15)
            
            if (Distancias[CE-1].d3 == 0)
            {
                ctx2.fillText( Distancias[CE-1].d3,rectx + DistanciasI[CE-1].d3/2 + 5,recty - (EngrenagensI[CE].diametro/2) - 20) //Cota da engrenagem 1
            }
            else
            {
                ctx2.fillText( Distancias[CE-1].d3,rectx + DistanciasI[CE-1].d3/2 - 10,recty - (EngrenagensI[CE].diametro/2) - 20) //Cota da engrenagem 1
            }
        }
        else
        {
            ...
            ctx2.moveTo(rectx + DistanciasI[CE].d4,recty - (EngrenagensI[CE].diametro/2) - 5)//Barra direita da cota da engrenagem 2
            ctx2.lineTo(rectx + DistanciasI[CE].d4,recty - (EngrenagensI[CE].diametro/2) - 55)
    
            ctx2.moveTo(rectx,recty - (EngrenagensI[CE].diametro/2) - 45)//Barra transversal da cota da engrenagem 2
            ctx2.lineTo(rectx + DistanciasI[CE].d4,recty -(EngrenagensI[CE].diametro/2) - 45)
    
            ctx2.fillText( Distancias[CE].d4,rectx + DistanciasI[CE].d4/2 - 5,recty - (EngrenagensI[CE].diametro/2) - 50)
        }
    }
}
...
function dadosdaengrenagem ()
{
    ...
    if (contadoreixos == 1)
    {
        ...
        if (c < 3)
        {
            ...
            ctx4.fillText("- Passo diâmetral normal: " + Engrenagens[CE].pdn + " dentes/in",20,135)
            ctx4.fillText("- Diâmetro: " + Engrenagens[CE].diametro + " in",20,160)
            ...
            ctx4.fillText("- Distância do início do eixo: " + Distancias[CE].d3  + " in",20,285)
        }
    }
    if (contadoreixos == 2)
    {
        ...
        if (c < 3)
        {
            ...
            ctx4.fillText("- Passo diâmetral normal: " + Engrenagens[CE].pdn + " dentes/in",290,135)
            ctx4.fillText("- Diâmetro: " + Engrenagens[CE].diametro + " in",290,160)
            ...
            ctx4.fillText("- Distância do início do eixo: " + Distancias[CE].d3  + " in",290,285)
        }
    }
    ctx4.stroke() 
    ctx4.closePath()
...
function corrigirdados2 ()
{
    ...
    if (document.getElementById('pdn').disabled)
    {
        document.getElementById('pdn').removeAttribute('disabled')
    }
...
function calculo()
{
    ...
    let di2 = Engrenagens[0].diametro 
    ...
    let di3 = Engrenagens[1].diametro 
    let de3 = Distancias[1].d3   
      
    
    // eixo a é composto pelos mancais A e B
    let compeixoa = Eixos[0].comprimento 
    
    if (Distancias[0].d1 < Distancias[0].d2)
    {
        var dA = Distancias[0].d1  //Conseiderando A como mancal esquerdo
        var dB = Distancias[0].d2 
    }
    else if (Distancias[0].d1 > Distancias[0].d2)
    {
        var dA = Distancias[0].d2  //Conseiderando A como mancal esquerdo
        var dB = Distancias[0].d1 
    }
    let de2 = Distancias[0].d3 
    ...
    let compeixob = Eixos[1].comprimento 
    
    if (Distancias[1].d1 < Distancias[1].d2)
    {
        var dC = Distancias[1].d1  //Conseiderando C como mancal esquerdo
        var dD = Distancias[1].d2 
    }
    else if (Distancias[1].d1 > Distancias[1].d2)
    {
        var dC = Distancias[1].d2  //Conseiderando C como mancal esquerdo
        var dD = Distancias[1].d1   
    }
    ...
    let F23t = t/(di2/2) //Determinação da força tangencial
    ...
    */
    ...
    document.getElementById('f23').innerHTML = 'F23 = [ ' + F23[0].toFixed(2) + ', ' + F23[1].toFixed(2) + ', ' + F23[2].toFixed(2) + ' ]' + ' lbf'
    ...
    document.getElementById('f32').innerHTML = 'F32 = [ ' + F32[0].toFixed(2) + ', ' + F32[1].toFixed(2) + ', ' + F32[2].toFixed(2) + ' ]' + ' lbf'
    ...
    */
    ...
    document.getElementById('fa').innerHTML = 'FA = [ ' + FA[0].toFixed(2) + ', ' + FA[1].toFixed(2) + ', ' + FA[2].toFixed(2) + ' ]' + ' lbf'
    document.getElementById('fb').innerHTML = 'FB = [ ' + FB[0].toFixed(2) + ', ' + FB[1].toFixed(2) + ', ' + FB[2].toFixed(2) + ' ]' + ' lbf'
    ...
    for (x = 0, MFxa=[], Xa=[]; x <= l1+l2+l3+l4; x=x+0.05)
    {
        if (x>= 0 && x<= l1)
        {
            i = 0
    ...
    for (x = 0, MFya=[]; x <= l1+l2+l3+l4; x=x+0.05)
    {
        if (x>= 0 && x<= l1)
        {
            i = 0
    ...
    {
        document.getElementById('momaxa').innerHTML = 'O momento fletor máximo no eixo \'a\' é de '+ MmaxxA.toFixed(2) + ' lbf.in em X'
    }
    else
    {
        document.getElementById('momaxa').innerHTML = 'O momento fletor máximo no eixo \'a\' é de '+ MmaxyA.toFixed(2) + ' lbf.in em Y'
    }
    ...
    document.getElementById('fc').innerHTML = 'FC = [ ' + FC[0].toFixed(2) + ', ' + FC[1].toFixed(2) + ', ' + FC[2].toFixed(2) + ' ]' + ' lbf'
    document.getElementById('fd').innerHTML = 'FD = [ ' + FD[0].toFixed(2) + ', ' + FD[1].toFixed(2) + ', ' + FD[2].toFixed(2) + ' ]' + ' lbf'
    ...
    for (x = 0, MFxb=[], Xb=[]; x <= l1+l2+l3+l4; x=x+0.05)
    {
        if (x>= 0 && x<= l1)
        {
            i = 0
    ...
    for (x = 0, MFyb=[]; x <= l1+l2+l3+l4; x=x+0.05)
    {
        if (x>= 0 && x<= l1)
        {
            i = 0
    ...
    {
        document.getElementById('momaxb').innerHTML = 'O momento fletor máximo no eixo \'b\' é de '+ MmaxxB.toFixed(2) + ' lbf.in em X'
    }
    else
    {
        document.getElementById('momaxb').innerHTML = 'O momento fletor máximo no eixo \'b\' é de '+ MmaxyB.toFixed(2) + ' lbf.in em Y'
    }
